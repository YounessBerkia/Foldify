...
class RuleMatchResult:
    ...
    confidence is always 1.0 for non-ai rules, only varies for ai_match.
    """
...
class RuleEngine:
    ...
    def __init__(
        ...
        # TODO: add max cache size to prevent memory bloat on large dirs
    ...
    def match_file(self, file_path: Path) -> RuleMatchResult:
        ...
        """
        # collect any ai_match rules for fallback
        ...
        # if no rule matched and ai is available, try ai classification
    ...
    def _normalize_text(value: str) -> str:
        ...
        Using NFKD normalization to handle umlauts and other diacritics.
        """
