...
class AIClient:
    ...
    Uses lazy loading for the ollama package to avoid import errors
    ...
    def __init__(self, config: AIConfig, cache_dir: Path | None = None):
        ...
        # set up cache directory for storing ai results
    ...
    def _build_prompt(
        ...
        TODO: make prompt configurable per user preference or profile.
        """
